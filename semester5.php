...
<head>
  <meta charset="UTF-8">
  <title>Semester 5 Resources - IGNOU BCA CMS</title>
...
<!-- Main content -->
<div class="container">
  <div class="accordion" id="semester5Accordion">
    ...
    <div class="accordion-item">
      ...
      <div id="collapseBooks" class="accordion-collapse collapse show" data-bs-parent="#semester5Accordion">
    ...
    <div class="accordion-item">
      ...
      <div id="collapseVideos" class="accordion-collapse collapse" data-bs-parent="#semester5Accordion">
        <div class="accordion-body">
          <ul class="list-group">
    ...
    <div class="accordion-item">
      ...
      <div id="collapseAssignments" class="accordion-collapse collapse" data-bs-parent="#semester5Accordion">
        <div class="accordion-body">
          <ul class="list-group">
    ...
    <div class="accordion-item">
      ...
      <div id="collapsePYQ" class="accordion-collapse collapse" data-bs-parent="#semester5Accordion">
        <div class="accordion-body">
          <ul class="list-group">
